<script lang="ts">
    ...
    function MouseEventHandler(_evt: MouseEvent) {
        console.log(_evt);
    }
</script>
...
<style>
    ...
    .highlight {
        ...
        background: radial-gradient(#ff9900, #f0f0f000 200%);
        user-select: none;
        cursor: pointer;
    }
    .label {
...
<main
    ...
    {#if active}
        <div
            class="highlight"
            style="background: radial-gradient(#0099ff, #f0f0f000 {Math.round(50+value*150.0)}%);"
